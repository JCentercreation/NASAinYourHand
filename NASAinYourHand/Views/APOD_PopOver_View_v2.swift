...
struct APOD_PopOver_View_v2: View {
    ...
    var body: some View {
        ...
        }.background(Image(uiImage: dayImage.info!.image).resizable())
            .cornerRadius(15)
    }
